...
QT_MOC_LITERAL(3, 29, 22), // "currentProgressChanged"
QT_MOC_LITERAL(4, 52, 5), // "bytes"
QT_MOC_LITERAL(5, 58, 10), // "totalbytes"
QT_MOC_LITERAL(6, 69, 18), // "onDownloadFinished"
QT_MOC_LITERAL(7, 88, 14), // "QNetworkReply*"
QT_MOC_LITERAL(8, 103, 5), // "reply"
QT_MOC_LITERAL(9, 109, 16) // "downloadProgress"

    },
    "Downloader\0downloadComplete\0\0"
    "currentProgressChanged\0bytes\0totalbytes\0"
...
void Downloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->downloadComplete((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: _t->currentProgressChanged((*reinterpret_cast< qint64(*)>(_a[1])),(*reinterpret_cast< qint64(*)>(_a[2]))); break;
        ...
        {
            typedef void (Downloader::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Downloader::downloadComplete)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Downloader::currentProgressChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Downloader::downloadComplete(bool _t1)
{
...
// SIGNAL 1
void Downloader::currentProgressChanged(qint64 _t1, qint64 _t2)
{
